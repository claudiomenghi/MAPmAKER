        ...
        for m=1:numberOfprocess
            ...
            for nextstateAutMpos = 1:numel(nextstatesM)
                ...
                for t=1:act_no           
                    ...
                    if ~isempty(Buchi.trans{currentstate(baindex),t})
                        nextstateproperty=Buchi.trans{currentstate(baindex),t};
                        ...
                        if isequal(intersect(propertyservices,sys(currentProcessIndex).Pi),nextstateOfMServices)
                           ...
                           NEW_STATES_PROGRESSIVE_FUNCTION(indexOfConfiguration)=nextstate(numberOfprocess+1);
