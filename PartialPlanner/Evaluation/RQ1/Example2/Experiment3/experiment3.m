...
for initNumber=1:ModelsExperiment3.numberOfInitialConfigurations
    ...
    for partialInfoNumber=1:ModelsExperiment3.numberOfPartialInfoConfigurations
        ...
        if(init==curr)
            ...
            writeExperimentResults('resultsex3.txt', experimentNumber, initNumber, partialInfoNumber, falseEvicenceCounterstep1, trueEvidenceCounterstep1, solutionfoundstep1, solutionfoundstep2, planningtimestep1, planningtimestep2, planlengthstep1, planlengthstep2)
